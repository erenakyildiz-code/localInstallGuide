...
|---|---|---|---|
| **brain** | llama.cpp server running your GGUF model | `8080` | `POST /completion` LLAMA.cpp TYPE ENDPOINT, you can use openai type if you go and change the c# api MANUALLY. IT IS RECOMMENDED YOU USE GOOGLE'S GEMMA 4 |
